...
@section('main_content')
    ...
    <div class="container static-page p-4">
        <div class="top-line-content">
            <div class="desc" hct-content="description" hct-content-type="rich_text" hct-title='توضیحات'>
                <p>رضایتمندی مشتریان همواره نخستین هدف لارامرس بوده است و در همین راستا تمامی کالاها در انبار مجموعه باز
                ...
                <br/>
                <strong class="question">شرایط استفاده از 3 روز ضمانت بازگشت کالا در لارامرس</strong>
                <br/>
                ...
                <div class="answer">
                    <ul>
                        <li><p>اگر کالایی که از لارامرس خریده اید دارای ایراد فنی باشد، شما باید حداکثر تا ۳ روز پس از
                                دریافت کالا، به لارامرس اطلاع دهید.</p></li>
                ...
                <div class="answer">
                    <ul>
                        <li><p>زمانی که کالا تحویل داده شد، اگر از لحاظ مشخصات فنی و ظاهری، با آنچه در سایت درج شده است، متفاوت بود، باید حداکثر تا ۲۴ ساعت طی تماس تلفنی به خدمات پس از فروش لارامرس اطلاع داده شود.</p></li>
                ...
                <div class="answer">
                    <ul>
                        <li><p>اگر کالایی که به دستتان رسیده از نظر فیزیکی و ظاهری دارای آسیب دیدگی است، حداکثر تا 24 ساعت پس از دریافت کالا، این موضوع را طی تماس تلفنی به بخش خدمات پس از فروش لارامرس اطلاع دهید.</p></li>
                ...
                <div class="answer">
                    <ul>
                        <li><p>این مورد نیز  باید حداکثر تا 24 ساعت پس از دریافت کالا توسط مشتری، به خدمات پس از فروش لارامرس گزارش شود.</p></li>
                        <li><p>تمامی کالاها با بسته بندی استاندارد و مطمئن، آماده ارسال می‌شوند. تحویل کالا به شرکت‌های حمل و نقل معتبر به انتخاب کاربر به این معناست که در صورتی که هر گونه حادثه‌ای در هنگام حمل و تحویل رخ داد، به عهده شرکت حمل و نقل است و لارامرس تنها در صورتی خسارت وارد شده در حین حمل و نقل را متقبل می‌شود که شرکت حمل کننده کالا مورد تاییدش باشد.</p></li>
                        ...
                        <li><p>کالایی که آسیب دیده باید به همراه همه لوازم جانبی و به همان شکل اولیه که تحویل مشتری داده شده است و به همراه فاکتور به بخش خدمات پس از فروش لارامرس داده شود.</p></li>
                        <li><p>همچنین اگر در همان موقع تحویل کالا، این آسیب دیدگی رخ دهد، شما می‌توانید از تحویل آن خودداری کنید تا کالا به لارامرس برگردانده و پیگیری شود.</p></li>
                    </ul>
                </div>
                ...
                <p>لارامرس کالاهای مرجوعی را بررسی می‌کند، اگر با مقرراتی که در بالا ذکر شده بود همخوانی نداشت و شامل ضمانت بازگشت نمی‌شد، آن کالا را برای مشتری مجددا ارسال می‌کند. اگر مشتری از قبول آن سرباز زد، کالا به مدت یک ماه به صورت امانت نزد لارامرس نگه داشته می‌شود و بعد از آن دیگر هیچ مسئولیتی در قبال خسارت و گم شدن کالا نخواهد داشت.</p>

                <strong class="question">
                    چگونه باید کالای مشکل‌دار را برای لارامرس ارسال کنید و هزینه ارسال بر عهده کیست؟
                </strong>
                <div class="answer">
                    <ul>
                        <li><p>حتما در صورت مشاهده مشکل و قبل از ارسال کالا با کارشناسان واحد خدمات پس از فروش لارامرس با شماره تلفن ۲۶۱۱۰۰۷ تماس بگیرید و از ارسال کالا بدون هماهنگی با آن‌ها خودداری فرمایید.</p></li>
                        <li><p>بعد از هماهنگی با کارشناسان، کالا را با بسته بندی اصلی و به همراه هر آنچه داخل بسته بندی بوده است برای لارامرس ارسال کنید.</p></li>
                        ...
                        <li><p>اگر کالا را با پست پیشتاز برای لارامرس ارسال کردید، حتما عکسی از رسید پستی را به آدرسinfo@larammerce.com ایمیل کنید.</p></li>
                        ...
                        <li><p>اگر ساکن سایر شهرها هستید، حتما با استفاده از پست پیشتاز کالا را برای لارامرس ارسال کنید و اگر ساکن تهران هستید برای هماهنگی برای فرستادن پیک جهت تحویل کالا با لارامرس تماس حاصل فرمایید.</p></li>
                        <li><p>هزینه برگرداندن کالا در صورتی با لارامرس است که با پست پیشتاز انجام گیرد. با ارائه قبض شرکت پست، درصورتی که کالا مشمول خدمات پس از فروش بشود و ایرادات مطرح شده به تایید کارشناسان برسد، هزینه پست به حسابتان واریز می‌شود. حتما عکسی از قبض پست را برای لارامرس ایمیل کنید.</p></li>
                        <li><p>در صورتی که از خرید منصرف شده باشید و یا ایرادت مطرح شده توسط لارامرس تایید نشود، هزینه ارسال به عهده شما خواهد بود.</p></li>
                    </ul>
                </div>
                ...
                <p>هنگامی که کالا به لارامرس بازگشت، کارشناسان ما کار بررسی و کنترل کالا را شروع می‌کنند. اگر مشکلی که مشتری مطرح کرده بود درست بود، کالا تعویض شده و یا به درخواست مشتری با کالای دیگری جایگزین می‌گردد.</p>
                <p>اگر از کالا در انبار لارامرس موجودی نبود، یا کالای دیگری بنابر توافق با مشتری جایگزین می‌شود و یا وجه پرداختی به حساب مشتری واریز می‌گردد. اگر کالای جایگزین ما به التفاوت داشت، قبل از ارسال حتما تسویه می‌شود؛ اگر گران‌تر بود مشتری باید مبلغ مازاد را پرداخت کند و اگر ارزان‌تر بود، لارامرس مبلغ تفاوت را به حساب مشتری برمی‌گرداند.</p>
                <p>در صورت نبود موجودی و یا تغییر قیمت کالا در زمان تعویض، لارامرس تعهدی ندارد و تنها می‌تواند وجه پرداختی مشتری را برگرداند.</p>
                <p>مدت زمان بررسی کالای مرجوعی توسط کارشناسان لارامرس حدود ۴۸ ساعت خواهد بود، چرا که ممکن است نیاز به ارتباط با نمایندگی‌های مجاز باشد. بعد از مشخص شدن و تایید مشکل اگر نیاز به برگشت پول به حساب مشتری بود، ظرف مدت ۴۸ ساعت این مبلغ به حساب مشتری واریز می‌شود.</p>
                ...
                <ul>
                    ...
                    <li><p>ارسال ایمیل بهinfo@larammerce.com(حتما شماره پیگیری سفارش خود را ذکر کنید).</p></li>
                </ul>
            </div>
        </div>
    </div>
