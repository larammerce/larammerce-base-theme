...
<div class="modal fade" id="add-to-homeScreen-android-modal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="question">
                    برای افزودن آیکون نسخه موبایل لارامرس در مرورگر از نوار بالای صفحه آیکون <i
...
<div class="modal fade" id="add-to-homeScreen-iphone-modal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="question">
                    برای افزودن آیکون نسخه موبایل لارامرس در مرورگر safary از نوار پایین صفحه، آیکون <img
