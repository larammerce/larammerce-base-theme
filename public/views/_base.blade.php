...
<head>
    ...
    <meta name="owner" content="larammerce">
    <meta name="topic"
    ...
    @yield('meta_tags')
    <meta property="og:site_name" content="larammerce">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <a class="navbar-brand-mobile hidden-xl hidden-lg hidden-md" href="/"
                   title="لارامرس">
                    <img src="/HCMS-assets/img/logo-larammerce.svg"
...
<footer class="@yield('footer_class')">
    <img src="/HCMS-assets/img/banner.png" class="pattern" height="120px" alt="larammerce pattern">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="contact">
                        ...
                        <p>
                            ایمیل:
                            <br/><span>info@larammerce.com</span>
                        </p>
                        <ul class="social-networks">
                            <li><a href="https://instagram.com/larammercecom/" title="instagram" target="_blank">
                                    <i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                            <li><a href="https://www.facebook.com/larammerce-271999456730079" title="facebook"
                                   target="_blank">
                                    <i class="fa fa-facebook-square" aria-hidden="true"></i></a></li>
                            <li><a href="https://www.linkedin.com/company/larammerce/" title="larammerce"
                                   target="_blank">
                                    <i class="fa fa-linkedin-square" aria-hidden="true"></i></a></li>
                            <li><a href="https://www.youtube.com/channel/UCRKYfh5uL7VrbWuoMiqeMaA" title="larammerce"
                                   target="_blank">
                                    <i class="fa fa-youtube-play" aria-hidden="true"></i></a>
                            </li>
                            <li><a href="https://www.pinterest.com/larammercecom" title="larammerce" target="_blank">
                                    <i class="fa fa-pinterest" aria-hidden="true"></i></a></li>
                            <li><a href="https://virgool.io/@larammerce" title="larammerce" target="_blank">
                            ...
                            <li><a href="https://www.aparat.com/larammerce" title="larammerce" target="_blank">
		...
		c1.1,0.2,1.8,1.2,1.6,2.3l0,0C382.7,162.8,381.7,163.5,380.6,163.3C380.6,163.3,380.6,163.3,380.6,163.3"/>
                ...
                <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
                    ...
                    {{--<div class="newsletter">
                        ...
                        <div class="motto">از تخفیف ها و جدیدترین های لارامرس با خبر شوید !</div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="licenses">
                        ...
                        <img src="/HCMS-assets/img/ecunion-logo.png" alt=""
                             onclick="window.open('https://ecunion.ir/verify/larammerce.com?token=75449105c7a07823c2b9', 'Popup',
    ...
    <div class="bottom-footer">
        <div class="container">
            ...
            <div class="copyright">
                LARAMMERCE.COM © ALL RIGHTS RESERVED
            </div>
        </div>
    </div>
</footer>
...
<!-- Hotjar Tracking Code for https://larammerce.com/ -->
<script>
