        ...
        <div class="top-line-content">
            ...
            <div class="product-list">
                <div class="pd-list-header">
                    ...
                    <div class="col col-lg-1">تعداد</div>
                    <div class="col col-lg-2">تخفیف</div>
                ...
                <div class="pd-list-body">
                    @foreach($invoice->rows as $row)
                        <div class="pd-list-item" product-box
                            ...
                            <div class="col col-lg-2 price price-single unit-price">
                            ...
                            <div class="col col-lg-1 counter-box-{{$row->product->id}} count-group">
                            ...
                            <div class="col col-lg-2 price unit-price">
                                <span class="hidden-xl hidden-lg">مجموع قیمت:</span>
            ...
            <div class="info">
                ...
                @if($invoice->shipment_cost > 0)
                    <div class="info-row">
                        ...
                        <div>این سفارش از طریق تحويل لارامرس با مبلغ
