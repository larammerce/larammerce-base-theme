    ...
    <div class="about">
        ...
        <section class="about-top-video">
            <video autoplay muted poster="/HCMS-assets/video/poster.jpg" loop
                ...
                <source src="/HCMS-assets/video/larammerce.mp4" type="video/mp4">
        ...
        <section class="container about-content">
            <div class="row about-row">
                <div class="col-lg-5 col-md-6 col-sm-8 col-xs-12 about-text">
                    <img src="/HCMS-assets/img/logo-b.svg" alt="larammerce logo" class="logo"/>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-5 col-sm-3 col-xs-12">
                            <div class="about-bold-pic">
                                <img src="/HCMS-assets/img/logo2.svg" width="100px" alt="larammerce">
                            </div>
                        </div>
                        <div class="col-lg-7 col-md-7 col-sm-9 col-xs-12">
                            <div class="desc" hct-content="larammerce_desc" hct-content-type="rich_text"
                                 hct-title='متن تک لارامرس'>
                                لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است،
                            </div>
                        </div>
                    </div>
